# np.TestPluginUpdatesWithAwait Changelog

## About np.TestPluginUpdatesWithAwait Plugin

See Plugin [README](https://github.com/NotePlan/plugins/blob/main/np.TestPluginUpdatesWithAwait/README.md) for details on available commands and use case.
